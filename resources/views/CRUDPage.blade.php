...
@section('content')
	...
	<div class="row grids_of_3">
					<div class="col-md-4 grid1_of_3">
						  <h2>tambah data</h2>
						  <img src="../public/images/icon1.png" class="img-responsive"/>
					...
					<div class="col-md-4 grid1_of_3">
						<h2>HAPUS DATA</h2>
						  <img src="../public/images/icon3.png" class="img-responsive"/>
					...
					<div class="col-md-4 grid1_of_3">
						<h2>ubah data</h2>
						  <img src="../public/images/icon2.png" class="img-responsive"/>
